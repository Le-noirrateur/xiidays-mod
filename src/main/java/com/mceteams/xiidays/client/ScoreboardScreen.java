...
public class ScoreboardScreen extends Screen {
    ...
    private static ResourceLocation customBackground = null;
    ...
    private void renderRankBadge(GuiGraphics graphics, int x, int y, int rank) {
        ...
        if (numeralTexture != null) {
            try {
                int numeralSize = 24;
                int numeralX = x + (frameSize - numeralSize) / 2;
                int numeralY = centeredY + (frameSize - numeralSize) / 2;
