...
public class TeamSpawnerRenderer implements BlockEntityRenderer<SpawnerBlockEntity> {

    public TeamSpawnerRenderer(BlockEntityRendererProvider.Context ctx) {}

    @Override
    public void render(@NotNull SpawnerBlockEntity spawner, float partialTicks, @NotNull PoseStack poseStack,
    ...
    @Override
    public boolean shouldRenderOffScreen(@NotNull SpawnerBlockEntity blockEntity) {
        return true;
    }
}
